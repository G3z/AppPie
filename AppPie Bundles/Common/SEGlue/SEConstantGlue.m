...
+ (SEConstant *)blankBD {
    static SEConstant *constantObj;
    if (!constantObj)
        constantObj = [SEConstant constantWithName: @"blankBD" type: typeType code: 'dhbd'];
    return constantObj;
}
...
+ (SEConstant *)videoBD {
    static SEConstant *constantObj;
    if (!constantObj)
        constantObj = [SEConstant constantWithName: @"videoBD" type: typeType code: 'dhvb'];
    return constantObj;
}
